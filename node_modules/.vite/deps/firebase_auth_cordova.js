...
// node_modules/@firebase/auth/dist/cordova/popup_redirect-abcbab4c.js
      ...
      return __awaiter(_this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              db = request.result;
              if (!!db.objectStoreNames.contains(DB_OBJECTSTORE_NAME)) return [3, 3];
              db.close();
...
function _debugErrorMap() {
  ...
  ] = "The mobile app identifier is not registered for the current project.", _a2[
    "invalid-user-token"
          ...
          return __generator(this, function(_a3) {
            switch (_a3.label) {
              ...
              case 1:
                ...
                fetchArgs = __assign({ method, headers }, body);
                if (!isCloudflareWorker()) {
                  fetchArgs.referrerPolicy = "no-referrer";
                }
                return [2, FetchProvider.fetch()(_getFinalTarget(auth, auth.config.apiHost, path, query), fetchArgs)];
            }
          });
        });
      })];
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_a2) {
      switch (_a2.label) {
        ...
        case 3:
          e_1 = _a2.sent();
          if (!(e_1 instanceof FirebaseError && isUserInvalidated(e_1))) return [3, 5];
...
var StsTokenManager = (
  ...
  function() {
    ...
    StsTokenManager2.prototype.updateFromIdToken = function(idToken) {
      _assert(
        idToken.length !== 0,
        "internal-error"
        /* AuthErrorCode.INTERNAL_ERROR */
...
var UserImpl = (
  ...
  function() {
          ...
          switch (_a2.label) {
            case 0:
              if (_isFirebaseServerApp(this.auth.app)) {
                return [2, Promise.reject(_serverAppCurrentUserOperationNotSupportedError(this.auth))];
              }
    ...
    UserImpl2._fromGetAccountInfoResponse = function(auth, response, idToken) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a2) {
          ...
          providerData = coreAccount.providerUserInfo !== void 0 ? extractProviderData(coreAccount.providerUserInfo) : [];
              ...
              return [4, Promise.all(persistenceHierarchy.map(function(persistence2) {
                return __awaiter(_this, void 0, void 0, function() {
                  return __generator(this, function(_b2) {
                    switch (_b2.label) {
                      case 0:
                        if (!(persistence2 !== selectedPersistence)) return [3, 4];
                        _b2.label = 1;
                      case 1:
                        _b2.trys.push([1, 3, , 4]);
...
var AuthImpl = (
  ...
  function() {
    ...
    AuthImpl2.prototype.initializeCurrentUserFromIdToken = function(idToken) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a2) {
          switch (_a2.label) {
            case 0:
              _a2.trys.push([0, 4, , 6]);
              return [4, getAccountInfo(this, { idToken })];
            case 1:
              response = _a2.sent();
              return [4, UserImpl._fromGetAccountInfoResponse(this, response, idToken)];
            case 2:
              user = _a2.sent();
            ...
            case 4:
              ...
              return [4, this.directlySetCurrentUser(null)];
            case 5:
              _a2.sent();
              return [3, 6];
            case 6:
    ...
    AuthImpl2.prototype.updateCurrentUser = function(userExtern) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a2) {
          if (_isFirebaseServerApp(this.app)) {
            return [2, Promise.reject(_serverAppCurrentUserOperationNotSupportedError(this))];
          }
    ...
    AuthImpl2.prototype.validatePassword = function(password) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a2) {
          switch (_a2.label) {
            case 0:
              if (!!this._getPasswordPolicyInternal()) return [3, 2];
    ...
    AuthImpl2.prototype.revokeAccessToken = function(token) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a2) {
          switch (_a2.label) {
            case 0:
              if (!this.currentUser) return [3, 3];
              return [4, this.currentUser.getIdToken()];
            case 1:
              idToken = _a2.sent();
              request = {
      ...
      switch (_b.label) {
        case 0:
          if (_isFirebaseServerApp(auth.app)) {
            return [2, Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth))];
          }
          authInternal = _castAuth(auth);
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_a2) {
      switch (_a2.label) {
        case 0:
          authInternal = _castAuth(auth);
          if (!authInternal._getPasswordPolicyInternal()) return [3, 2];
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            ...
            case 2:
              ...
              if (!hasPendingRedirect) return [3, 4];
    ...
    return __generator(this, function(_a2) {
      switch (_a2.label) {
        case 0:
          ...
          if (_isFirebaseServerApp(userInternal.auth.app)) {
            return [2, Promise.reject(_serverAppCurrentUserOperationNotSupportedError(userInternal.auth))];
          }
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_a2) {
      switch (_a2.label) {
        ...
        case 1:
          result = _a2.sent();
          if (!(result && !bypassAuthState)) return [3, 4];
...
@firebase/auth/dist/cordova/popup_redirect-abcbab4c.js:
  (**
   * @license
